...
namespace CodeBase.SDK.ADS
{
    ...
    {
        public void ShowRewardAd(Action onOpenCallback = null, Action onRewardedCallback = null,
            Action onCloseCallback = null, Action<string> onErrorCallback = null)
        {
            VideoAd.Show(onOpenCallback, onRewardedCallback, onCloseCallback, onErrorCallback);
        }

        public void ShowInterstitialAd(Action onOpenCallback = null, Action<bool> onCloseCallback = null,
