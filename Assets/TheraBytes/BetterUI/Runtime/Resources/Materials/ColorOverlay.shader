...
#pragma multi_compile __ FORCE_CLIP
	...
	{
        half4 origCol = (tex2D(_MainTex, IN.texcoord) + _TextureSampleAdd);
        half4 color = lerp(origCol, IN.color, IN.amount.x);
		color.a = min(origCol.a, color.a);
